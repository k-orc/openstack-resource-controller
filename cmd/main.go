...
import (
	...
	openstackv1alpha1 "github.com/gophercloud/openstack-resource-controller/api/v1alpha1"
...
func main() {
	...
	if err = (&controller.OpenStackPortReconciler{
		Client:   mgr.GetClient(),
		Scheme:   mgr.GetScheme(),
		Recorder: recorder,
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "OpenStackPort")
		os.Exit(1)
	}
	...
	if err = (&controller.OpenStackSubnetReconciler{
		...
		setupLog.Error(err, "unable to create controller", "controller", "OpenStackSubnet")
		os.Exit(1)
	}
	...
	if err = (&controller.OpenStackKeypairReconciler{
		Client:   mgr.GetClient(),
		Scheme:   mgr.GetScheme(),
		Recorder: recorder,
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "OpenStackKeypair")
		os.Exit(1)
	}
