...
| `networkRef` _[KubernetesNameRef](#kubernetesnameref)_ | networkRef is a reference to the ORC Network which this resource is associated with.l |  | MaxLength: 253 <br />MinLength: 1 <br /> |
