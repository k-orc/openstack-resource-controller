...
_Validation:_
- Enum: [affinity anti-affinity soft-affinity soft-anti-affinity max_server_per_host]
...
| --- | --- | --- | --- |
| `name` _[OpenStackName](#openstackname)_ | name will be the name of the created resource. If not specified, the<br />name of the ORC object will be used. |  | MaxLength: 255 <br />MinLength: 1 <br />Pattern: `^[^,]+$` <br /> |
| `policy` _[ServerGroupPolicy](#servergrouppolicy)_ | policy is the policy to use for the server group. |  | Enum: [affinity anti-affinity soft-affinity soft-anti-affinity max_server_per_host] <br /> |
...
| `rules` _[ServerGroupRules](#servergrouprules)_ | rules is the rules of the server group. |  |  |
