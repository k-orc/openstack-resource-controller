...
//+kubebuilder:rbac:groups=openstack.gophercloud.io,resources=openstacksubnets,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=openstack.gophercloud.io,resources=openstacksubnets/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=openstack.gophercloud.io,resources=openstacksubnets/finalizers,verbs=update
