...
type NetworkClient interface {
	...
	UpdatePort(id string, opts ports.UpdateOptsBuilder) (*PortExt, error)
...
func (c networkClient) UpdatePort(id string, opts ports.UpdateOptsBuilder) (*PortExt, error) {
	portExt := PortExt{}
	if err := ports.Update(context.TODO(), c.serviceClient, id, opts).ExtractInto(&portExt); err != nil {
		return nil, err
	}
	return &portExt, nil
}
