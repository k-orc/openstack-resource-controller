...
// Fundamental types
type (
	orcObjectT     = orcv1alpha1.Domain
	orcObjectListT = orcv1alpha1.DomainList
	resourceSpecT  = orcv1alpha1.DomainResourceSpec
	filterT        = orcv1alpha1.DomainFilter
)
