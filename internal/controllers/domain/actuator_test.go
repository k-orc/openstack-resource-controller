...
func TestHandleNameUpdate(t *testing.T) {
	...
	for _, tt := range testCases {
		t.Run(tt.name, func(t *testing.T) {
			resource := &orcv1alpha1.Domain{}
			resource.Name = "object-name"
			resource.Spec = orcv1alpha1.DomainSpec{
				Resource: &orcv1alpha1.DomainResourceSpec{Name: tt.newValue},
			}
...
func TestHandleDescriptionUpdate(t *testing.T) {
	...
	for _, tt := range testCases {
		t.Run(tt.name, func(t *testing.T) {
			resource := &orcv1alpha1.DomainResourceSpec{Description: tt.newValue}
