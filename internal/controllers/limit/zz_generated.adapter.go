...
// Fundamental types
type (
	orcObjectT     = orcv1alpha1.Limit
	orcObjectListT = orcv1alpha1.LimitList
	resourceSpecT  = orcv1alpha1.LimitResourceSpec
	filterT        = orcv1alpha1.LimitFilter
)
