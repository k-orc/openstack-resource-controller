...
// Fundamental types
type (
	orcObjectT     = orcv1alpha1.Volume
	orcObjectListT = orcv1alpha1.VolumeList
	resourceSpecT  = orcv1alpha1.VolumeResourceSpec
	filterT        = orcv1alpha1.VolumeFilter
)
