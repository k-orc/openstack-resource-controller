...
// Fundamental types
type (
	orcObjectT     = orcv1alpha1.Region
	orcObjectListT = orcv1alpha1.RegionList
	resourceSpecT  = orcv1alpha1.RegionResourceSpec
	filterT        = orcv1alpha1.RegionFilter
)
