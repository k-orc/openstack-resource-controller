...
// Fundamental types
type (
	orcObjectT     = orcv1alpha1.Share
	orcObjectListT = orcv1alpha1.ShareList
	resourceSpecT  = orcv1alpha1.ShareResourceSpec
	filterT        = orcv1alpha1.ShareFilter
)
