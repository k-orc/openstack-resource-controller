...
// Fundamental types
type (
	orcObjectT     = orcv1alpha1.AddressScope
	orcObjectListT = orcv1alpha1.AddressScopeList
	resourceSpecT  = orcv1alpha1.AddressScopeResourceSpec
	filterT        = orcv1alpha1.AddressScopeFilter
)
...
type (
	...
	adapterT    = addressscopeAdapter
)

type addressscopeAdapter struct {
	*orcv1alpha1.AddressScope
}

var _ adapterI = &adapterT{}

func (f adapterT) GetObject() orcObjectPT {
	return f.AddressScope
}
