...
// Fundamental types
type (
	orcObjectT     = orcv1alpha1.SwiftContainer
	orcObjectListT = orcv1alpha1.SwiftContainerList
	resourceSpecT  = orcv1alpha1.SwiftContainerResourceSpec
	filterT        = orcv1alpha1.SwiftContainerFilter
)
...
type (
	...
	adapterT    = swiftcontainerAdapter
)

type swiftcontainerAdapter struct {
	*orcv1alpha1.SwiftContainer
}

var _ adapterI = &adapterT{}

func (f adapterT) GetObject() orcObjectPT {
	return f.SwiftContainer
}
...
func (f adapterT) GetImportID() *string {
	...
	if f.Spec.Import.Name == nil {
		return nil
	}
	name := string(*f.Spec.Import.Name)
	return &name
}
