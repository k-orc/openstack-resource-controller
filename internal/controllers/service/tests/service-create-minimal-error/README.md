# Create a Service with the minimum options

## Step 00

Create a minimal Service, that sets the required fields except the name, and verify that the observed state should get in error.
