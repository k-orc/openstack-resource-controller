...
// Fundamental types
type (
	orcObjectT     = orcv1alpha1.Service
	orcObjectListT = orcv1alpha1.ServiceList
	resourceSpecT  = orcv1alpha1.ServiceResourceSpec
	filterT        = orcv1alpha1.ServiceFilter
)
