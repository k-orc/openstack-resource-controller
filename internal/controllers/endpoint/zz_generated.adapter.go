...
// Fundamental types
type (
	orcObjectT     = orcv1alpha1.Endpoint
	orcObjectListT = orcv1alpha1.EndpointList
	resourceSpecT  = orcv1alpha1.EndpointResourceSpec
	filterT        = orcv1alpha1.EndpointFilter
)
