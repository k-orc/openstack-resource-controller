...
// Fundamental types
type (
	orcObjectT     = orcv1alpha1.LBPool
	orcObjectListT = orcv1alpha1.LBPoolList
	resourceSpecT  = orcv1alpha1.LBPoolResourceSpec
	filterT        = orcv1alpha1.LBPoolFilter
)
...
type (
	...
	adapterT    = lbpoolAdapter
)

type lbpoolAdapter struct {
	*orcv1alpha1.LBPool
}
