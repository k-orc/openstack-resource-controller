...
// Fundamental types
type (
	orcObjectT     = orcv1alpha1.VolumeType
	orcObjectListT = orcv1alpha1.VolumeTypeList
	resourceSpecT  = orcv1alpha1.VolumeTypeResourceSpec
	filterT        = orcv1alpha1.VolumeTypeFilter
)
...
type (
	...
	adapterT    = volumetypeAdapter
)

type volumetypeAdapter struct {
	*orcv1alpha1.VolumeType
}
