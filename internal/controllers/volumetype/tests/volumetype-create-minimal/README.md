# Create a VolumeType with the minimum options

## Step 00

Create a minimal VolumeType, that sets only the required fields, and verify that the observed state corresponds to the spec.
