...
import (
	...
	"github.com/k-orc/openstack-resource-controller/v3/internal/controllers/generic/resync"
	"github.com/k-orc/openstack-resource-controller/v3/internal/controllers/generic/status"
...
func (r *roleassignmentReconciler) newActuator(ctx context.Context, orcObject orcObjectPT) (roleassignmentActuator, progress.ReconcileStatus) {
	...
	_, reconcileStatus := credentialsDependency.RequireDependencies(ctx, r.client, orcObject, func(*corev1.Secret) bool { return true })
