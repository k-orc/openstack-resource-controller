...
func TestHandleNameUpdate(t *testing.T) {
	...
	for _, tt := range testCases {
		t.Run(tt.name, func(t *testing.T) {
			resource := &orcv1alpha1.RoleAssignment{}
			resource.Name = "object-name"
			resource.Spec = orcv1alpha1.RoleAssignmentSpec{
				Resource: &orcv1alpha1.RoleAssignmentResourceSpec{Name: tt.newValue},
			}
...
func TestHandleDescriptionUpdate(t *testing.T) {
	...
	for _, tt := range testCases {
		t.Run(tt.name, func(t *testing.T) {
			resource := &orcv1alpha1.RoleAssignmentResourceSpec{Description: tt.newValue}
