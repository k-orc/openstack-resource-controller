...
// Fundamental types
type (
	orcObjectT     = orcv1alpha1.User
	orcObjectListT = orcv1alpha1.UserList
	resourceSpecT  = orcv1alpha1.UserResourceSpec
	filterT        = orcv1alpha1.UserFilter
)
