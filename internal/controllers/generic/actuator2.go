...
type ResourceHelperFactory[
	...
	NewCreateActuator(ctx context.Context, orcObject orcObjectPT, controller ResourceController) ([]WaitingOnEvent, CreateResourceActuator2[orcObjectPT, orcObjectT, filterT, osResourceT], error)
	NewDeleteActuator(ctx context.Context, orcObject orcObjectPT, controller ResourceController) ([]WaitingOnEvent, DeleteResourceActuator2[orcObjectPT, orcObjectT, osResourceT], error)
}

type BaseResourceActuator2[
	orcObjectPT interface {
		*orcObjectT
		client.Object
		orcv1alpha1.ObjectWithConditions
...
type CreateResourceActuator2[
	...
	BaseResourceActuator2[orcObjectPT, orcObjectT, osResourceT]
...
func GetOrCreateOSResource2[
	...
	actuator CreateResourceActuator2[orcObjectPT, orcObjectT, filterT, osResourceT],
...
func getResourceForAdoption[
	...
	ctx context.Context,
	actuator BaseResourceActuator2[orcObjectPT, orcObjectT, osResourceT],
	objAdapter APIObjectAdapter[orcObjectPT, resourceSpecT, filterT],
) (*osResourceT, error) {
...
func DeleteResource2[
	...
	ctx context.Context, log logr.Logger, controller ResourceController,
	objAdapter APIObjectAdapter[orcObjectPT, resourceSpecT, filterT],
	actuator DeleteResourceActuator2[orcObjectPT, orcObjectT, osResourceT],
