...
// Fundamental types
type (
	orcObjectT     = orcv1alpha1.Group
	orcObjectListT = orcv1alpha1.GroupList
	resourceSpecT  = orcv1alpha1.GroupResourceSpec
	filterT        = orcv1alpha1.GroupFilter
)
