...
Create Groups referencing non-existing resources. Each Group is dependent on other non-existing resource. Verify that the Groups are waiting for the needed resources to be created externally.
