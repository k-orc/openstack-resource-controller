...
// Fundamental types
type (
	orcObjectT     = orcv1alpha1.ApplicationCredential
	orcObjectListT = orcv1alpha1.ApplicationCredentialList
	resourceSpecT  = orcv1alpha1.ApplicationCredentialResourceSpec
	filterT        = orcv1alpha1.ApplicationCredentialFilter
)
...
type (
	...
	adapterT    = applicationcredentialAdapter
)

type applicationcredentialAdapter struct {
...
func (f adapterT) GetObject() orcObjectPT {
	return f.ApplicationCredential
}
