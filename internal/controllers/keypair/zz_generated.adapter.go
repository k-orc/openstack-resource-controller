...
// Fundamental types
type (
	orcObjectT     = orcv1alpha1.KeyPair
	orcObjectListT = orcv1alpha1.KeyPairList
	resourceSpecT  = orcv1alpha1.KeyPairResourceSpec
	filterT        = orcv1alpha1.KeyPairFilter
)
