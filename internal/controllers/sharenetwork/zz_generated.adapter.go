...
// Fundamental types
type (
	orcObjectT     = orcv1alpha1.ShareNetwork
	orcObjectListT = orcv1alpha1.ShareNetworkList
	resourceSpecT  = orcv1alpha1.ShareNetworkResourceSpec
	filterT        = orcv1alpha1.ShareNetworkFilter
)
...
type (
	...
	adapterT    = sharenetworkAdapter
)

type sharenetworkAdapter struct {
	*orcv1alpha1.ShareNetwork
}

var _ adapterI = &adapterT{}

func (f adapterT) GetObject() orcObjectPT {
	return f.ShareNetwork
}
