...
// Fundamental types
type (
	orcObjectT     = orcv1alpha1.VolumeSnapshot
	orcObjectListT = orcv1alpha1.VolumeSnapshotList
	resourceSpecT  = orcv1alpha1.VolumeSnapshotResourceSpec
	filterT        = orcv1alpha1.VolumeSnapshotFilter
)
