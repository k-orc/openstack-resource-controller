# Create a VolumeSnapshot with the minimum options

## Step 00

Create a minimal VolumeSnapshot, that sets only the required fields, and verify that the observed state corresponds to the spec.
