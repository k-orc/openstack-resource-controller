...
var _ = Describe("ORC Image API validations", func() {
	...
	It("should permit modifying resource.properties", func(ctx context.Context) {
	...
	It("should permit modifying resource.properties.hardware", func(ctx context.Context) {
