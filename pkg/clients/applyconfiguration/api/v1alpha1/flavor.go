...
// Flavor constructs a declarative configuration of the Flavor type for use with
// apply.
...
// ExtractFlavor extracts the applied configuration owned by fieldManager from
// flavor. If no managedFields are found in flavor for fieldManager, a
// FlavorApplyConfiguration is returned with only the Name, Namespace (if applicable),
// APIVersion and Kind populated. It is possible that no managed fields were found for because other
// field managers have taken ownership of all the fields previously owned by fieldManager, or because
// the fieldManager never owned fields any fields.
// flavor must be a unmodified Flavor API object that was retrieved from the Kubernetes API.
// ExtractFlavor provides a way to perform a extract/modify-in-place/apply workflow.
...
func ExtractFlavor(flavor *apiv1alpha1.Flavor, fieldManager string) (*FlavorApplyConfiguration, error) {
	return extractFlavor(flavor, fieldManager, "")
}

// ExtractFlavorStatus is the same as ExtractFlavor except
// that it extracts the status subresource applied configuration.
// Experimental!
func ExtractFlavorStatus(flavor *apiv1alpha1.Flavor, fieldManager string) (*FlavorApplyConfiguration, error) {
	return extractFlavor(flavor, fieldManager, "status")
}

func extractFlavor(flavor *apiv1alpha1.Flavor, fieldManager string, subresource string) (*FlavorApplyConfiguration, error) {
	b := &FlavorApplyConfiguration{}
	err := managedfields.ExtractInto(flavor, internal.Parser().Type("com.github.k-orc.openstack-resource-controller.v3.api.v1alpha1.Flavor"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
	b.WithName(flavor.Name)
	b.WithNamespace(flavor.Namespace)
...
func (b *FlavorApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
