...
type ShareTypeResourceSpecApplyConfiguration struct {
	...
	ExtraSpecs *ShareTypeExtraSpecRequiredApplyConfiguration `json:"extraSpecs,omitempty"`
}
...
// WithExtraSpecs sets the ExtraSpecs field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the ExtraSpecs field is set to the value of the last call.
func (b *ShareTypeResourceSpecApplyConfiguration) WithExtraSpecs(value *ShareTypeExtraSpecRequiredApplyConfiguration) *ShareTypeResourceSpecApplyConfiguration {
	b.ExtraSpecs = value
	return b
}
