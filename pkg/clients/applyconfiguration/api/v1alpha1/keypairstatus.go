...
func KeyPairStatus() *KeyPairStatusApplyConfiguration {
	return &KeyPairStatusApplyConfiguration{}
}

// WithConditions adds the given value to the Conditions field in the declarative configuration
// and returns the receiver, so that objects can be build by chaining "With" function invocations.
// If called multiple times, values provided by each call will be appended to the Conditions field.
func (b *KeyPairStatusApplyConfiguration) WithConditions(values ...*v1.ConditionApplyConfiguration) *KeyPairStatusApplyConfiguration {
	for i := range values {
		if values[i] == nil {
...
func (b *KeyPairStatusApplyConfiguration) WithID(value string) *KeyPairStatusApplyConfiguration {
	b.ID = &value
	return b
}
