...
// ServerImportApplyConfiguration represents a declarative configuration of the ServerImport type for use
// with apply.
...
// ServerImportApplyConfiguration constructs a declarative configuration of the ServerImport type for use with
// apply.
func ServerImport() *ServerImportApplyConfiguration {
	return &ServerImportApplyConfiguration{}
}
