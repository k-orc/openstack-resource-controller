...
type LBPoolSpecApplyConfiguration struct {
	Import              *LBPoolImportApplyConfiguration              `json:"import,omitempty"`
	Resource            *LBPoolResourceSpecApplyConfiguration        `json:"resource,omitempty"`
...
func (b *LBPoolSpecApplyConfiguration) WithImport(value *LBPoolImportApplyConfiguration) *LBPoolSpecApplyConfiguration {
	b.Import = value
	return b
}
...
func (b *LBPoolSpecApplyConfiguration) WithResource(value *LBPoolResourceSpecApplyConfiguration) *LBPoolSpecApplyConfiguration {
	b.Resource = value
	return b
}
...
func (b *LBPoolSpecApplyConfiguration) WithManagementPolicy(value apiv1alpha1.ManagementPolicy) *LBPoolSpecApplyConfiguration {
...
func (b *LBPoolSpecApplyConfiguration) WithManagedOptions(value *ManagedOptionsApplyConfiguration) *LBPoolSpecApplyConfiguration {
...
func (b *LBPoolSpecApplyConfiguration) WithCloudCredentialsRef(value *CloudCredentialsReferenceApplyConfiguration) *LBPoolSpecApplyConfiguration {
