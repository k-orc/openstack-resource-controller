...
func (b *UserResourceSpecApplyConfiguration) WithName(value apiv1alpha1.KeystoneName) *UserResourceSpecApplyConfiguration {
	b.Name = &value
	return b
}
...
func (b *UserResourceSpecApplyConfiguration) WithDefaultProjectID(value string) *UserResourceSpecApplyConfiguration {
...
func (b *UserResourceSpecApplyConfiguration) WithPassword(value string) *UserResourceSpecApplyConfiguration {
	b.Password = &value
	return b
}
