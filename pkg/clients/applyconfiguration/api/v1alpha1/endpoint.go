...
func extractEndpoint(endpoint *apiv1alpha1.Endpoint, fieldManager string, subresource string) (*EndpointApplyConfiguration, error) {
	b := &EndpointApplyConfiguration{}
	err := managedfields.ExtractInto(endpoint, internal.Parser().Type("com.github.k-orc.openstack-resource-controller.v3.api.v1alpha1.Endpoint"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
