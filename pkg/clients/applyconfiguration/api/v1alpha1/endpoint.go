...
func ExtractEndpoint(endpoint *apiv1alpha1.Endpoint, fieldManager string) (*EndpointApplyConfiguration, error) {
	return extractEndpoint(endpoint, fieldManager, "")
}

// ExtractEndpointStatus is the same as ExtractEndpoint except
...
func ExtractEndpointStatus(endpoint *apiv1alpha1.Endpoint, fieldManager string) (*EndpointApplyConfiguration, error) {
	return extractEndpoint(endpoint, fieldManager, "status")
}

func extractEndpoint(endpoint *apiv1alpha1.Endpoint, fieldManager string, subresource string) (*EndpointApplyConfiguration, error) {
	b := &EndpointApplyConfiguration{}
	err := managedfields.ExtractInto(endpoint, internal.Parser().Type("com.github.k-orc.openstack-resource-controller.v2.api.v1alpha1.Endpoint"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
	b.WithName(endpoint.Name)
	b.WithNamespace(endpoint.Namespace)
