...
func (b *FloatingIPSpecApplyConfiguration) WithImport(value *FloatingIPImportApplyConfiguration) *FloatingIPSpecApplyConfiguration {
	b.Import = value
	return b
}
...
func (b *FloatingIPSpecApplyConfiguration) WithResource(value *FloatingIPResourceSpecApplyConfiguration) *FloatingIPSpecApplyConfiguration {
	b.Resource = value
	return b
}
...
func (b *FloatingIPSpecApplyConfiguration) WithManagementPolicy(value apiv1alpha1.ManagementPolicy) *FloatingIPSpecApplyConfiguration {
...
func (b *FloatingIPSpecApplyConfiguration) WithManagedOptions(value *ManagedOptionsApplyConfiguration) *FloatingIPSpecApplyConfiguration {
...
func (b *FloatingIPSpecApplyConfiguration) WithCloudCredentialsRef(value *CloudCredentialsReferenceApplyConfiguration) *FloatingIPSpecApplyConfiguration {
