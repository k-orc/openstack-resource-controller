...
func (b *VolumeSpecApplyConfiguration) WithImport(value *VolumeImportApplyConfiguration) *VolumeSpecApplyConfiguration {
	b.Import = value
	return b
}
...
func (b *VolumeSpecApplyConfiguration) WithResource(value *VolumeResourceSpecApplyConfiguration) *VolumeSpecApplyConfiguration {
	b.Resource = value
	return b
}
...
func (b *VolumeSpecApplyConfiguration) WithManagementPolicy(value apiv1alpha1.ManagementPolicy) *VolumeSpecApplyConfiguration {
...
func (b *VolumeSpecApplyConfiguration) WithManagedOptions(value *ManagedOptionsApplyConfiguration) *VolumeSpecApplyConfiguration {
...
func (b *VolumeSpecApplyConfiguration) WithCloudCredentialsRef(value *CloudCredentialsReferenceApplyConfiguration) *VolumeSpecApplyConfiguration {
