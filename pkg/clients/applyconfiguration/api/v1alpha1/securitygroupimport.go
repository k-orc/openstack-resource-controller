...
// SecurityGroupImportApplyConfiguration represents a declarative configuration of the SecurityGroupImport type for use
// with apply.
...
// SecurityGroupImportApplyConfiguration constructs a declarative configuration of the SecurityGroupImport type for use with
// apply.
func SecurityGroupImport() *SecurityGroupImportApplyConfiguration {
	return &SecurityGroupImportApplyConfiguration{}
}
