...
// KeyPairSpecApplyConfiguration constructs a declarative configuration of the KeyPairSpec type for use with
// apply.
func KeyPairSpec() *KeyPairSpecApplyConfiguration {
	return &KeyPairSpecApplyConfiguration{}
}
...
func (b *KeyPairSpecApplyConfiguration) WithImport(value *KeyPairImportApplyConfiguration) *KeyPairSpecApplyConfiguration {
	b.Import = value
	return b
}
...
func (b *KeyPairSpecApplyConfiguration) WithResource(value *KeyPairResourceSpecApplyConfiguration) *KeyPairSpecApplyConfiguration {
	b.Resource = value
	return b
}
...
func (b *KeyPairSpecApplyConfiguration) WithManagementPolicy(value apiv1alpha1.ManagementPolicy) *KeyPairSpecApplyConfiguration {
...
func (b *KeyPairSpecApplyConfiguration) WithCloudCredentialsRef(value *CloudCredentialsReferenceApplyConfiguration) *KeyPairSpecApplyConfiguration {
