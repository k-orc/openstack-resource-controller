...
// with apply.
type ApplicationCredentialSpecApplyConfiguration struct {
	Import              *ApplicationCredentialImportApplyConfiguration       `json:"import,omitempty"`
...
// ApplicationCredentialSpecApplyConfiguration constructs a declarative configuration of the ApplicationCredentialSpec type for use with
// apply.
func ApplicationCredentialSpec() *ApplicationCredentialSpecApplyConfiguration {
	return &ApplicationCredentialSpecApplyConfiguration{}
}
...
func (b *ApplicationCredentialSpecApplyConfiguration) WithImport(value *ApplicationCredentialImportApplyConfiguration) *ApplicationCredentialSpecApplyConfiguration {
	b.Import = value
	return b
}
...
func (b *ApplicationCredentialSpecApplyConfiguration) WithResource(value *ApplicationCredentialResourceSpecApplyConfiguration) *ApplicationCredentialSpecApplyConfiguration {
	b.Resource = value
	return b
}
...
func (b *ApplicationCredentialSpecApplyConfiguration) WithManagementPolicy(value apiv1alpha1.ManagementPolicy) *ApplicationCredentialSpecApplyConfiguration {
...
func (b *ApplicationCredentialSpecApplyConfiguration) WithCloudCredentialsRef(value *CloudCredentialsReferenceApplyConfiguration) *ApplicationCredentialSpecApplyConfiguration {
