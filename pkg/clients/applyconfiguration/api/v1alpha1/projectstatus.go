...
func (b *ProjectStatusApplyConfiguration) WithConditions(values ...*v1.ConditionApplyConfiguration) *ProjectStatusApplyConfiguration {
	for i := range values {
		if values[i] == nil {
...
func (b *ProjectStatusApplyConfiguration) WithID(value string) *ProjectStatusApplyConfiguration {
	b.ID = &value
	return b
}
...
func (b *ProjectStatusApplyConfiguration) WithResource(value *ProjectResourceStatusApplyConfiguration) *ProjectStatusApplyConfiguration {
	b.Resource = value
	return b
}
