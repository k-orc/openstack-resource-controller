...
type UserApplyConfiguration struct {
	...
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	...
	Status                           *UserStatusApplyConfiguration `json:"status,omitempty"`
}
...
// Experimental!
func ExtractUser(user *apiv1alpha1.User, fieldManager string) (*UserApplyConfiguration, error) {
...
// Experimental!
func ExtractUserStatus(user *apiv1alpha1.User, fieldManager string) (*UserApplyConfiguration, error) {
	return extractUser(user, fieldManager, "status")
}

func extractUser(user *apiv1alpha1.User, fieldManager string, subresource string) (*UserApplyConfiguration, error) {
	b := &UserApplyConfiguration{}
	...
	b.WithNamespace(user.Namespace)
