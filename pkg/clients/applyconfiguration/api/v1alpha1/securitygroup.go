...
func ExtractSecurityGroup(securityGroup *apiv1alpha1.SecurityGroup, fieldManager string) (*SecurityGroupApplyConfiguration, error) {
	return extractSecurityGroup(securityGroup, fieldManager, "")
}

// ExtractSecurityGroupStatus is the same as ExtractSecurityGroup except
...
func ExtractSecurityGroupStatus(securityGroup *apiv1alpha1.SecurityGroup, fieldManager string) (*SecurityGroupApplyConfiguration, error) {
	return extractSecurityGroup(securityGroup, fieldManager, "status")
}
...
func extractSecurityGroup(securityGroup *apiv1alpha1.SecurityGroup, fieldManager string, subresource string) (*SecurityGroupApplyConfiguration, error) {
	...
	b.WithNamespace(securityGroup.Namespace)
