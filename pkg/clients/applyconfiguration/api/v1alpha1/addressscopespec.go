...
// with apply.
type AddressScopeSpecApplyConfiguration struct {
	Import              *AddressScopeImportApplyConfiguration        `json:"import,omitempty"`
...
// AddressScopeSpecApplyConfiguration constructs a declarative configuration of the AddressScopeSpec type for use with
// apply.
func AddressScopeSpec() *AddressScopeSpecApplyConfiguration {
	return &AddressScopeSpecApplyConfiguration{}
}
...
func (b *AddressScopeSpecApplyConfiguration) WithImport(value *AddressScopeImportApplyConfiguration) *AddressScopeSpecApplyConfiguration {
	b.Import = value
	return b
}
...
func (b *AddressScopeSpecApplyConfiguration) WithResource(value *AddressScopeResourceSpecApplyConfiguration) *AddressScopeSpecApplyConfiguration {
	b.Resource = value
	return b
}
...
func (b *AddressScopeSpecApplyConfiguration) WithManagementPolicy(value apiv1alpha1.ManagementPolicy) *AddressScopeSpecApplyConfiguration {
...
func (b *AddressScopeSpecApplyConfiguration) WithManagedOptions(value *ManagedOptionsApplyConfiguration) *AddressScopeSpecApplyConfiguration {
...
func (b *AddressScopeSpecApplyConfiguration) WithCloudCredentialsRef(value *CloudCredentialsReferenceApplyConfiguration) *AddressScopeSpecApplyConfiguration {
