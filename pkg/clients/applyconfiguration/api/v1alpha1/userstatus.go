...
func (b *UserStatusApplyConfiguration) WithID(value string) *UserStatusApplyConfiguration {
	b.ID = &value
	return b
}
...
func (b *UserStatusApplyConfiguration) WithResource(value *UserResourceStatusApplyConfiguration) *UserStatusApplyConfiguration {
	b.Resource = value
	return b
}
