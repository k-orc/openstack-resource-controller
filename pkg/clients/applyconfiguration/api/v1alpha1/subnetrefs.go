...
// apply.
func SubnetRefs() *SubnetRefsApplyConfiguration {
	return &SubnetRefsApplyConfiguration{}
}
...
func (b *SubnetRefsApplyConfiguration) WithNetworkRef(value v1alpha1.ORCNameRef) *SubnetRefsApplyConfiguration {
	b.NetworkRef = &value
	return b
}
