...
func extractRoleAssignment(roleAssignment *apiv1alpha1.RoleAssignment, fieldManager string, subresource string) (*RoleAssignmentApplyConfiguration, error) {
	b := &RoleAssignmentApplyConfiguration{}
	err := managedfields.ExtractInto(roleAssignment, internal.Parser().Type("com.github.k-orc.openstack-resource-controller.v3.api.v1alpha1.RoleAssignment"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
