...
// HostAggregateSpecApplyConfiguration represents a declarative configuration of the HostAggregateSpec type for use
// with apply.
type HostAggregateSpecApplyConfiguration struct {
	Import              *HostAggregateImportApplyConfiguration       `json:"import,omitempty"`
	Resource            *HostAggregateResourceSpecApplyConfiguration `json:"resource,omitempty"`
...
// HostAggregateSpecApplyConfiguration constructs a declarative configuration of the HostAggregateSpec type for use with
// apply.
func HostAggregateSpec() *HostAggregateSpecApplyConfiguration {
...
func (b *HostAggregateSpecApplyConfiguration) WithImport(value *HostAggregateImportApplyConfiguration) *HostAggregateSpecApplyConfiguration {
	b.Import = value
	return b
}
...
func (b *HostAggregateSpecApplyConfiguration) WithResource(value *HostAggregateResourceSpecApplyConfiguration) *HostAggregateSpecApplyConfiguration {
	b.Resource = value
	return b
}
...
func (b *HostAggregateSpecApplyConfiguration) WithManagementPolicy(value apiv1alpha1.ManagementPolicy) *HostAggregateSpecApplyConfiguration {
...
func (b *HostAggregateSpecApplyConfiguration) WithManagedOptions(value *ManagedOptionsApplyConfiguration) *HostAggregateSpecApplyConfiguration {
...
func (b *HostAggregateSpecApplyConfiguration) WithCloudCredentialsRef(value *CloudCredentialsReferenceApplyConfiguration) *HostAggregateSpecApplyConfiguration {
