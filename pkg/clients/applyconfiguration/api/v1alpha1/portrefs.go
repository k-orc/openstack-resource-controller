...
// apply.
func PortRefs() *PortRefsApplyConfiguration {
	return &PortRefsApplyConfiguration{}
}
...
func (b *PortRefsApplyConfiguration) WithNetworkRef(value apiv1alpha1.KubernetesNameRef) *PortRefsApplyConfiguration {
	b.NetworkRef = &value
	return b
}
