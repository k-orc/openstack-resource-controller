...
// SwiftContainerMetadataApplyConfiguration constructs a declarative configuration of the SwiftContainerMetadata type for use with
// apply.
func SwiftContainerMetadata() *SwiftContainerMetadataApplyConfiguration {
...
func (b *SwiftContainerMetadataApplyConfiguration) WithValue(value string) *SwiftContainerMetadataApplyConfiguration {
	b.Value = &value
	return b
}
