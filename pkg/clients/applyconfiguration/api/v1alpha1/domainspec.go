...
func (b *DomainSpecApplyConfiguration) WithImport(value *DomainImportApplyConfiguration) *DomainSpecApplyConfiguration {
	b.Import = value
	return b
}
...
func (b *DomainSpecApplyConfiguration) WithResource(value *DomainResourceSpecApplyConfiguration) *DomainSpecApplyConfiguration {
	b.Resource = value
	return b
}
...
func (b *DomainSpecApplyConfiguration) WithManagementPolicy(value apiv1alpha1.ManagementPolicy) *DomainSpecApplyConfiguration {
...
func (b *DomainSpecApplyConfiguration) WithManagedOptions(value *ManagedOptionsApplyConfiguration) *DomainSpecApplyConfiguration {
...
func (b *DomainSpecApplyConfiguration) WithCloudCredentialsRef(value *CloudCredentialsReferenceApplyConfiguration) *DomainSpecApplyConfiguration {
