...
func (b *GroupSpecApplyConfiguration) WithImport(value *GroupImportApplyConfiguration) *GroupSpecApplyConfiguration {
	b.Import = value
	return b
}
...
func (b *GroupSpecApplyConfiguration) WithResource(value *GroupResourceSpecApplyConfiguration) *GroupSpecApplyConfiguration {
	b.Resource = value
	return b
}
...
func (b *GroupSpecApplyConfiguration) WithManagementPolicy(value apiv1alpha1.ManagementPolicy) *GroupSpecApplyConfiguration {
...
func (b *GroupSpecApplyConfiguration) WithCloudCredentialsRef(value *CloudCredentialsReferenceApplyConfiguration) *GroupSpecApplyConfiguration {
