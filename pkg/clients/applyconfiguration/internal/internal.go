...
- name: com.github.k-orc.openstack-resource-controller.v2.api.v1alpha1.KeyPairResourceSpec
  map:
    ...
    - name: privateKeySecretRef
      type:
        namedType: com.github.k-orc.openstack-resource-controller.v2.api.v1alpha1.SecretReference
    - name: publicKey
      type:
        scalar: string
    - name: type
...
- name: com.github.k-orc.openstack-resource-controller.v2.api.v1alpha1.SecretReference
  map:
    fields:
    - name: key
      type:
