...
- name: com.github.k-orc.openstack-resource-controller.v2.api.v1alpha1.ApplicationCredentialResourceSpec
  map:
    ...
    - name: secret
      type:
        namedType: com.github.k-orc.openstack-resource-controller.v2.api.v1alpha1.ApplicationCredentialSecretSpec
      default: {}
    - name: unrestricted
      type:
        scalar: boolean
...
- name: com.github.k-orc.openstack-resource-controller.v2.api.v1alpha1.ApplicationCredentialResourceStatus
  map:
    ...
    - name: unrestricted
      type:
        scalar: boolean
- name: com.github.k-orc.openstack-resource-controller.v2.api.v1alpha1.ApplicationCredentialSecretSpec
  map:
    fields:
    - name: secretRef
      type:
