...
func (c *OpenstackV1alpha1Client) ShareNetworks(namespace string) ShareNetworkInterface {
...
func (c *OpenstackV1alpha1Client) SubnetPools(namespace string) SubnetPoolInterface {
	return newSubnetPools(c, namespace)
}
