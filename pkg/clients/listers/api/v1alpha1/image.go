...
type ImageLister interface {
	...
	List(selector labels.Selector) (ret []*apiv1alpha1.Image, err error)
...
type imageLister struct {
	listers.ResourceIndexer[*apiv1alpha1.Image]
}

// NewImageLister returns a new ImageLister.
func NewImageLister(indexer cache.Indexer) ImageLister {
	return &imageLister{listers.New[*apiv1alpha1.Image](indexer, apiv1alpha1.Resource("image"))}
}

// Images returns an object that can list and get Images.
func (s *imageLister) Images(namespace string) ImageNamespaceLister {
	return imageNamespaceLister{listers.NewNamespaced[*apiv1alpha1.Image](s.ResourceIndexer, namespace)}
}
...
type ImageNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*apiv1alpha1.Image, error)
