...
type DomainLister interface {
	...
	List(selector labels.Selector) (ret []*apiv1alpha1.Domain, err error)
...
type domainLister struct {
	listers.ResourceIndexer[*apiv1alpha1.Domain]
}

// NewDomainLister returns a new DomainLister.
func NewDomainLister(indexer cache.Indexer) DomainLister {
	return &domainLister{listers.New[*apiv1alpha1.Domain](indexer, apiv1alpha1.Resource("domain"))}
}

// Domains returns an object that can list and get Domains.
func (s *domainLister) Domains(namespace string) DomainNamespaceLister {
	return domainNamespaceLister{listers.NewNamespaced[*apiv1alpha1.Domain](s.ResourceIndexer, namespace)}
}
...
type DomainNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*apiv1alpha1.Domain, error)
