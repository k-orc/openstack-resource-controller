...
type UserLister interface {
	...
	List(selector labels.Selector) (ret []*apiv1alpha1.User, err error)
...
type userLister struct {
	listers.ResourceIndexer[*apiv1alpha1.User]
}

// NewUserLister returns a new UserLister.
func NewUserLister(indexer cache.Indexer) UserLister {
	return &userLister{listers.New[*apiv1alpha1.User](indexer, apiv1alpha1.Resource("user"))}
}

// Users returns an object that can list and get Users.
func (s *userLister) Users(namespace string) UserNamespaceLister {
	return userNamespaceLister{listers.NewNamespaced[*apiv1alpha1.User](s.ResourceIndexer, namespace)}
}
...
type UserNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*apiv1alpha1.User, error)
