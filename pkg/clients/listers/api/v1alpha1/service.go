...
type ServiceLister interface {
	...
	List(selector labels.Selector) (ret []*apiv1alpha1.Service, err error)
...
type serviceLister struct {
	listers.ResourceIndexer[*apiv1alpha1.Service]
}

// NewServiceLister returns a new ServiceLister.
func NewServiceLister(indexer cache.Indexer) ServiceLister {
	return &serviceLister{listers.New[*apiv1alpha1.Service](indexer, apiv1alpha1.Resource("service"))}
}

// Services returns an object that can list and get Services.
func (s *serviceLister) Services(namespace string) ServiceNamespaceLister {
	return serviceNamespaceLister{listers.NewNamespaced[*apiv1alpha1.Service](s.ResourceIndexer, namespace)}
}
...
type ServiceNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*apiv1alpha1.Service, error)
