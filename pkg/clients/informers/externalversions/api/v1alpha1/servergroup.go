	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.OpenstackV1alpha1().ServerGroups(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.OpenstackV1alpha1().ServerGroups(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.OpenstackV1alpha1().ServerGroups(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.OpenstackV1alpha1().ServerGroups(namespace).Watch(ctx, options)
			},
		},
		&v2apiv1alpha1.ServerGroup{},
		resyncPeriod,
		indexers,
	)
}

func (f *serverGroupInformer) defaultInformer(client clientset.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
...
func (f *serverGroupInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&v2apiv1alpha1.ServerGroup{}, f.defaultInformer)
}

func (f *serverGroupInformer) Lister() apiv1alpha1.ServerGroupLister {
	return apiv1alpha1.NewServerGroupLister(f.Informer().GetIndexer())
}
