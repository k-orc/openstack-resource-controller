...
type RegisteredLimitResourceSpec struct {
	...
	// Using -1 will allow unlimited use of the resource. Using 0 will prevent usage of that resource entirely.
	// Note: Due to a bug in gophercloud, you can not currently set this to 0 when creating a RegisteredLimit.
