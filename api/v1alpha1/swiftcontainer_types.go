...
// SwiftContainerResourceSpec contains the desired state of the resource.
...
// SwiftContainerResourceStatus represents the observed state of the resource.
type SwiftContainerResourceStatus struct {
	...
	// TODO(scaffolding): Add more types.
	// To see what is supported, you can take inspiration from the Container structure from
	// github.com/gophercloud/gophercloud/v2/openstack/objectstorage/v1/containers
}
