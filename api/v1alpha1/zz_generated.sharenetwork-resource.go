...
type ShareNetworkImport struct {
	...
	// +optional
	Filter *ShareNetworkFilter `json:"filter,omitempty"`
}
...
type ShareNetworkSpec struct {
	...
	// +optional
	Resource *ShareNetworkResourceSpec `json:"resource,omitempty"`
...
type ShareNetworkStatus struct {
	...
	// +optional
	Resource *ShareNetworkResourceStatus `json:"resource,omitempty"`
}

var _ ObjectWithConditions = &ShareNetwork{}

func (i *ShareNetwork) GetConditions() []metav1.Condition {
...
type ShareNetwork struct {
	...
	// +required
	Spec ShareNetworkSpec `json:"spec,omitzero"`

	// status defines the observed state of the resource.
	// +optional
	Status ShareNetworkStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// ShareNetworkList contains a list of ShareNetwork.
type ShareNetworkList struct {
	metav1.TypeMeta `json:",inline"`
	...
	// items contains a list of ShareNetwork.
	// +required
	Items []ShareNetwork `json:"items"`
}

func (l *ShareNetworkList) GetItems() []ShareNetwork {
	return l.Items
}

func init() {
	SchemeBuilder.Register(&ShareNetwork{}, &ShareNetworkList{})
}

func (i *ShareNetwork) GetCloudCredentialsRef() (*string, *CloudCredentialsReference) {
	if i == nil {
		return nil, nil
	}
...
var _ CloudCredentialsRefProvider = &ShareNetwork{}
