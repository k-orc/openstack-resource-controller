...
type HostAggregateImport struct {
	...
	// +optional
	Filter *HostAggregateFilter `json:"filter,omitempty"`
}
...
type HostAggregateSpec struct {
	...
	// creating a new one.
	// +optional
	Import *HostAggregateImport `json:"import,omitempty"`
	...
	// +optional
	Resource *HostAggregateResourceSpec `json:"resource,omitempty"`
...
type HostAggregateStatus struct {
	...
	// +optional
	Resource *HostAggregateResourceStatus `json:"resource,omitempty"`
}

var _ ObjectWithConditions = &HostAggregate{}

func (i *HostAggregate) GetConditions() []metav1.Condition {
...
type HostAggregate struct {
	...
	// +optional
	Spec HostAggregateSpec `json:"spec,omitempty"`

	// status defines the observed state of the resource.
	// +optional
	Status HostAggregateStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// HostAggregateList contains a list of HostAggregate.
type HostAggregateList struct {
	metav1.TypeMeta `json:",inline"`
	...
	// items contains a list of HostAggregate.
	// +required
	Items []HostAggregate `json:"items"`
}

func (l *HostAggregateList) GetItems() []HostAggregate {
	return l.Items
}

func init() {
	SchemeBuilder.Register(&HostAggregate{}, &HostAggregateList{})
}

func (i *HostAggregate) GetCloudCredentialsRef() (*string, *CloudCredentialsReference) {
	if i == nil {
		return nil, nil
	}
...
var _ CloudCredentialsRefProvider = &HostAggregate{}
