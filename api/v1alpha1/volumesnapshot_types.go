...
type VolumeSnapshotResourceSpec struct {
	...
	// volumeRef is a reference to the ORC Volume which this resource is associated with.
	// +required
...
type VolumeSnapshotResourceStatus struct {
	...
	// volumeID is the ID of the Volume to which the resource is associated.
	// +kubebuilder:validation:MaxLength=1024
	// +optional
	VolumeID string `json:"volumeID,omitempty"`

	// TODO(scaffolding): Add more types.
	// To see what is supported, you can take inspiration from the Snapshot structure from
	// github.com/gophercloud/gophercloud/v2/openstack/blockstorage/v3/snapshots
}
