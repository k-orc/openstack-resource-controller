...
type SwiftContainerSpec struct {
	...
	// creating a new one.
	// +optional
	Import *SwiftContainerImport `json:"import,omitempty"`
	...
	// +optional
	Resource *SwiftContainerResourceSpec `json:"resource,omitempty"`
...
type SwiftContainerStatus struct {
	...
	// +optional
	Resource *SwiftContainerResourceStatus `json:"resource,omitempty"`
}

var _ ObjectWithConditions = &SwiftContainer{}

func (i *SwiftContainer) GetConditions() []metav1.Condition {
...
type SwiftContainer struct {
	...
	// +required
	Spec SwiftContainerSpec `json:"spec,omitzero"`

	// status defines the observed state of the resource.
	// +optional
	Status SwiftContainerStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// SwiftContainerList contains a list of SwiftContainer.
type SwiftContainerList struct {
	metav1.TypeMeta `json:",inline"`
	...
	// +required
	Items []SwiftContainer `json:"items"`
}

func (l *SwiftContainerList) GetItems() []SwiftContainer {
	return l.Items
}

func init() {
	SchemeBuilder.Register(&SwiftContainer{}, &SwiftContainerList{})
}
...
var _ CloudCredentialsRefProvider = &SwiftContainer{}
