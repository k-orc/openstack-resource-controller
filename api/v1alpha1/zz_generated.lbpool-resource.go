...
type LBPoolImport struct {
	...
	// +optional
	Filter *LBPoolFilter `json:"filter,omitempty"`
}
...
type LBPoolSpec struct {
	...
	// creating a new one.
	// +optional
	Import *LBPoolImport `json:"import,omitempty"`
	...
	// +optional
	Resource *LBPoolResourceSpec `json:"resource,omitempty"`
...
type LBPoolStatus struct {
	...
	// +optional
	Resource *LBPoolResourceStatus `json:"resource,omitempty"`
}

var _ ObjectWithConditions = &LBPool{}

func (i *LBPool) GetConditions() []metav1.Condition {
...
// LBPoolList contains a list of LBPool.
type LBPoolList struct {
	...
	// items contains a list of LBPool.
	// +required
	Items []LBPool `json:"items"`
}

func (l *LBPoolList) GetItems() []LBPool {
	return l.Items
}
...
func (i *LBPool) GetCloudCredentialsRef() (*string, *CloudCredentialsReference) {
	if i == nil {
		return nil, nil
	}
...
var _ CloudCredentialsRefProvider = &LBPool{}
