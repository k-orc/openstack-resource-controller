...
// SegmentationIDsSpec tests that SegmentationIDs is excluded (not an OpenStack resource).
type SegmentationIDsSpec struct {
	SegmentationIDs []int `json:"segmentationIDs,omitempty"`
}
